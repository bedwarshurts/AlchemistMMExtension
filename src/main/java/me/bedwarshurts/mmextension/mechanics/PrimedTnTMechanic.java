...
public class PrimedTnTMechanic extends SkillMechanic implements ITargetedLocationSkill {

    private final boolean breakBlocks;
    private final int fuseTicks;
    private final boolean damage;

    public PrimedTnTMechanic(SkillExecutor manager, File file, String line, MythicLineConfig mlc) {
