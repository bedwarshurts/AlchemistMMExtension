...
@MythicPlaceholder(placeholder = "caster.distanceFrom", description = "Returns distance from the caster to the targeter")
public class CasterDistanceFromTargeterPlaceholder implements MetaPlaceholder {
