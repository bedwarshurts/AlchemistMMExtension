...
@MythicTargeter(author = "bedwarshurts", name = "inheritedtargetgroundlocation", aliases = {"ITGL"}, description = "Targets the block location the inherited target is standing on")
public class InheritedGroundLevelTargeter implements ILocationTargeter {

    private final int yOffset;

    public InheritedGroundLevelTargeter(MythicLineConfig mlc) {
